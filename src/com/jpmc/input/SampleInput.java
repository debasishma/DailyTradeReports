...
public class SampleInput {
	public static Set<Instruction> getSampleInput() {
		...
		return new HashSet<>(Arrays.asList(
				...
				new Instruction("Amazon", InstructionType.SELL, LocalDate.of(2018, 3, 09), LocalDate.of(2018, 3, 17),
						new InstructionData(Currency.getInstance("SAR"), BigDecimal.valueOf(0.27), 150,
								BigDecimal.valueOf(400.8))),

				new Instruction("Google", InstructionType.SELL, LocalDate.of(2019, 5, 09), LocalDate.of(2019, 5, 20),
						new InstructionData(Currency.getInstance("EUR"), BigDecimal.valueOf(0.34), 50,
								BigDecimal.valueOf(500.6))),

				new Instruction("UAEBank", InstructionType.BUY, LocalDate.of(2017, 1, 04), LocalDate.of(2017, 1, 06),
						new InstructionData(Currency.getInstance("AED"), BigDecimal.valueOf(0.22), 450,
								BigDecimal.valueOf(150.5))),

				new Instruction("SingFed", InstructionType.BUY, LocalDate.of(2016, 1, 01), LocalDate.of(2016, 1, 02),
				...
				new Instruction("StanC", InstructionType.SELL, LocalDate.of(2018, 10, 06), LocalDate.of(2018, 10, 13),
